...
These two items can be downloaded directly\
In addition, the main model and dataset in the "release" folder also need to be downloaded\
File Directory:\
datasets\
detection/templates1/fulldata_bigClass_Knowledge.pth + fulldata_smallClass_Knowledge.pth\
llml20251201small_fullData_and_fullKnowledge_MainModel.pth\
